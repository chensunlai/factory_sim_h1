...
All the environments are registered in the `factory_sim_h1` extension. They start
...
import factory_sim_h1.tasks  # noqa: F401


def main():
    """Print all environments registered in `factory_sim_h1` extension."""
